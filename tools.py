...
def finance_tool(ticker: str, action: str = "data", period: str = "1mo", interval: str = "1d"):
    """
    A single finance tool that:
    - Gets stock data for a ticker
    - If action is 'plot', also returns a chart
    - If action is 'summarize', returns a short trend summary
    - If action is 'both', returns data, plot, and summary
